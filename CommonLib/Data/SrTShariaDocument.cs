...
{
    public partial class SrTShariaDocument
    {
        public SrTShariaDocument()
        {
            SrTBookMarkDocuments = new HashSet<SrTBookMarkDocument>();
            SrTDocumentComments = new HashSet<SrTDocumentComment>();
            SrTDocumentViews = new HashSet<SrTDocumentView>();
            SrTLinkedDocuments = new HashSet<SrTLinkedDocument>();
        ...
        public virtual ICollection<SrTBookMarkDocument> SrTBookMarkDocuments { get; set; }
        public virtual ICollection<SrTDocumentComment> SrTDocumentComments { get; set; }
        public virtual ICollection<SrTDocumentView> SrTDocumentViews { get; set; }
        public virtual ICollection<SrTLinkedDocument> SrTLinkedDocuments { get; set; }
